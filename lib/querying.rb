...
def select_series_title_with_most_human_characters
  "SELECT title FROM series JOIN characters ON characters.author_id = series.author_id GROUP BY(characters.species) ORDER BY(characters.species) DESC LIMIT 1;"
end
